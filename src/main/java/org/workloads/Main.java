...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < 100; i++) {
            bottom.add(as.actorOf(Service.props(null, 100, null, new Limiter.LimiterByErrors(200), Duration.ofMillis(100), false)));
        }
//        bottom.add(as.actorOf(Service.props(null, 100, null, new Limiter.LimiterByErrors(200), Duration.ofMillis(100), true)));
        ...
        for (int i = 0; i < 100; i++) {
            ...
            top.add(as.actorOf(Service.props(bottomEnvoy, 100, null, new Limiter.LimiterByErrors(200), Duration.ofMillis(100), false)));
        }
